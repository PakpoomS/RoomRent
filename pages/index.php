        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-default sidebar" role="navigation" >
                <div class="sidebar-nav navbar-collapse">
					...
					<li>
                            <a href="?menu=home"><i class="fa fa-home fa-fw"></i>หน้าหลัก</a>
                        </li>
                        ...
                        <li>
                         ...
                         <li>
                            <a href="?menu=room" <?php if($menu == "room"){echo 'class="active alert-danger"';} ?>><i class="fa fa-list-alt" aria-hidden="true"></i> รายชื่อห้องประชุม</a>
                        </li>
   ...
   <li class="sidebar-search">
                            <div class="input-group custom-search-form">
								  <form role="form" action="?menu=home#chkuser" method="post" name="login">
                                        ...
                                        <a href="?menu=register" class="btn btn-success btn-sm">สมัครสมาชิก</a>
                                        </p>
